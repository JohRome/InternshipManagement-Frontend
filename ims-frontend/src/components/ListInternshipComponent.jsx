...
const ListInternshipComponent = () => {
    ...
    function removeInternship(id) {
        ...
        deleteInternship(id).then((response) => {
            getAllInternships();
    ...
    return (
        <div className='container'>
            ...
            <button className='btn btn-primary mb-2' onClick={addNewInternship}>Add Internship</button>
                ...
                <tbody>
                    {
                        internships.map(internship =>
                            <tr key={internship.id}>
                                ...
                                <td>
                                    <button className='btn btn-info' onClick={() => updateInternship(internship.id)}>Update</button>
                                    <button className='btn btn-danger' onClick={() => removeInternship(internship.id)}
